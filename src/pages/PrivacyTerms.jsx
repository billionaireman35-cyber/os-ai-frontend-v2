  ...
  return (
    <div className="p-4 tablet:p-6 space-y-6">
      ...
      <div className="ledger-card p-6 max-w-3xl space-y-4">
        ...
        <p className="text-muted text-[12px] font-mono">Last updated: July 2026</p>
      </div>
    </div>
  );
}